...
public class XMLDataProviderTest extends ParentDataProviderBaseTest implements IAbstractTest{
    ...
    @Parameters({"a1", "b1", "c1"})
    public void testAddOperation(@Optional("1") int a1, @Optional("2") int b1, @Optional("3") int c1) {
        int actual = Integer.valueOf(a1) + Integer.valueOf(b1);
        int expected = Integer.valueOf(c1);
        LOGGER.info("arguments   " + String.valueOf(a1) + "," + String.valueOf(b1) + "," + String.valueOf(c1) + "   result   " + String.valueOf(actual) + "," + String.valueOf(expected));	
    ...
    public void testSubtractOperation(@Optional("3") int a2, @Optional("2") int b2, @Optional("1") int c2) {
        ...
        LOGGER.info("arguments   " + String.valueOf(a2) + "," + String.valueOf(b2) + "," + String.valueOf(c2) + "   result   " + String.valueOf(actual) + "," + String.valueOf(expected));	
    ...
    public void testMultiplyOperation(@Optional("2") int a3, @Optional("3") int b3, @Optional("6") int c3) {
        ...
        LOGGER.info("arguments   " + String.valueOf(a3) + "," + String.valueOf(b3) + "," + String.valueOf(c3) + "   result   " + String.valueOf(actual) + "," + String.valueOf(expected));	
    ...
    public void testDivideOperation(@Optional("8") int a4,  @Optional("4") int b4, @Optional("2") int c4) {
        ...
        LOGGER.info("arguments   " + String.valueOf(a4) + "," + String.valueOf(b4) + "," + String.valueOf(c4) + "   result   " + String.valueOf(actual) + "," + String.valueOf(expected));	
    ...
    public void testPowerOperation(@Optional("2") int a5, @Optional("3") int b5, @Optional("8") int c5) {
        ...
        LOGGER.info("arguments   " + String.valueOf(a5) + "," + String.valueOf(b5) + "," + String.valueOf(c5) + "   result   " + String.valueOf(actual) + "," + String.valueOf(expected));	
