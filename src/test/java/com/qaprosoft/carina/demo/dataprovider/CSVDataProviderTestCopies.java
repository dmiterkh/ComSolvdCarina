...
public class CSVDataProviderTestCopies extends ParentDataProviderBaseTest implements IAbstractTest{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(CSVDataProviderTestCopies.class);
	...
	*/
	...
	@XlsDataSourceParameters(path = "xls/dkharevich2/Addition.csv", sheet = "Addition", dsUid = "TUID", dsArgs = "a,b,c", testRailColumn = "a")
	...
	@Test(dataProvider = "DataProvider")
	@MethodOwner(owner = "dkharevich")
	@XlsDataSourceParameters(path = "xls/dkharevich2/Subtraction.csv", sheet = "Subtraction", dsUid = "TUID", dsArgs = "a,b,c", testRailColumn = "a")
	...
	@Test(dataProvider = "DataProvider")
	@MethodOwner(owner = "dkharevich")
	@XlsDataSourceParameters(path = "xls/dkharevich2/Multiplication.csv", sheet = "Multiplication", dsUid = "TUID", dsArgs = "a,b,c", testRailColumn = "a")
	...
	@Test(dataProvider = "DataProvider")
	@MethodOwner(owner = "dkharevich")
	@XlsDataSourceParameters(path = "xls/dkharevich2/Division.csv", sheet = "Division", dsUid = "TUID", dsArgs = "a,b,c", testRailColumn = "a")
	...
	@Test(dataProvider = "DataProvider")
	@MethodOwner(owner = "dkharevich")
	@XlsDataSourceParameters(path = "xls/dkharevich2/Power.csv", sheet = "Power", dsUid = "TUID", dsArgs = "a,b,c", testRailColumn = "a")
